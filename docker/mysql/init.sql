DROP DATABASE IF exists db_sales_lead;
CREATE DATABASE db_sales_lead;
USE db_sales_lead;
...
CREATE TABLE `jobs` (
    ...
    `updated_at` TIMESTAMP NOT NULL DEFAULT '2019-01-01 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
